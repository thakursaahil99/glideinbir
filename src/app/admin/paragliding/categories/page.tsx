...
export default function AdminParaglidingCategoriesPage() {
  return (
    <div>
      <h1 className="text-2xl font-bold tracking-tight">Paragliding categories</h1>
      <div className="mt-6">
        <SimpleEntityManager<Category>
          apiBase="/api/admin/paragliding/categories"
          fields={[
