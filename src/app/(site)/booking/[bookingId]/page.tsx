...
export default async function BookingPage({
  ...
  const lineItems: LineItem[] = [
    ...booking.paraglidingItems.map((item) => ({
      ...
      image: item.package.media[0]?.url ?? `https://picsum.photos/seed/${item.package.slug}/400/400`,
    ...
    ...booking.schoolItems.map((item) => ({
      ...
      icon: GraduationCap,
      category: "School",
      image: item.course.media[0]?.url ?? `https://picsum.photos/seed/${item.course.slug}/400/400`,
    ...
    ...booking.hotelItems.map((item) => ({
      ...
      icon: Hotel,
      category: "Hotel",
      image: item.room.media[0]?.url ?? item.hotel.media[0]?.url ?? `https://picsum.photos/seed/${item.roomId}/400/400`,
    ...
    ...booking.adventureItems.map((item) => ({
      ...
      icon: Tent,
      category: "Adventure",
      image: item.item.media[0]?.url ?? `https://picsum.photos/seed/${item.item.slug}/400/400`,
    ...
    ...booking.travelItems.map((item) => ({
      ...
      icon: Bus,
      category: "Travel",
      image: item.route.media[0]?.url ?? `https://picsum.photos/seed/${item.route.slug}/400/400`,
