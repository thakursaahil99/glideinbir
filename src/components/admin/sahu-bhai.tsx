  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full bg-gradient-to-br from-brand to-brand-dark py-2 pl-2 pr-4 text-sm font-semibold text-white shadow-lg transition-transform hover:scale-105"
      >
